...
namespace {
struct Ipc_CqueryStats : public IpcMessage<Ipc_CqueryStats> {
...
MAKE_REFLECT_STRUCT(CqueryStatsBody, files, workingFiles, queryFiles, fileConsumerUsed, symbols, includes);
